...
import { RawAlgoSchedule, TimeDict, RoomNumberDict } from '../algorithm/ScheduleGenerator';
import Meta from '../models/Meta';
import * as Utils from '../utils';
import Hashable from '../models/Hashable';
 ...
 */
export class Schedule extends VuexModule {
     ...
     */
    constructor(
        raw_schedule: [string, TimeDict, number[], RoomNumberDict][] = [],
        title = 'Schedule',
        id = 0,
        events: Event[] = []
    ) {
